...
let MyRealArray = otherArray.flat(Infinity)
console.log(MyRealArray); */

// console.log(Array.isArray([1,2,3])); // Check if Array or Not
// console.log(Array.from("Akshar")); // String Akshar Convert to Array Element
